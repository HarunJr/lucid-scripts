import {
  ...
  TProperties,
  TSchema,
} from "lucid-cardano/types/deps/deno.land/x/typebox@0.25.13/src/typebox.js";
import {
  Datum,
  Exact,
  Json,
  Redeemer,
} from "lucid-cardano/types/src/types/mod.js";
...
export declare const Data: {
  Integer: (options?: {
    ...
    import("lucid-cardano/types/deps/deno.land/x/typebox@0.25.13/src/typebox.js").TUnsafe<
      bigint
    >;
  Bytes: (options?: {
    minLength?: number;
  ...
  Array: <T extends TSchema>(items: T, options?: {
    ...
    import("lucid-cardano/types/deps/deno.land/x/typebox@0.25.13/src/typebox.js").TArray<
      T
    >;
  ...
  Object: <T_2 extends TProperties>(properties: T_2, options?: {
    ...
    import("lucid-cardano/types/deps/deno.land/x/typebox@0.25.13/src/typebox.js").TObject<
      T_2
    >;
  Enum: <T_3 extends TSchema>(
    items: T_3[],
  ) =>
    import("lucid-cardano/types/deps/deno.land/x/typebox@0.25.13/src/typebox.js").TUnion<
      T_3[]
    >;
  /**
  ...
  Tuple: <T_4 extends TSchema[]>(items: [...T_4], options?: {
    ...
    import("lucid-cardano/types/deps/deno.land/x/typebox@0.25.13/src/typebox.js").TTuple<
      T_4
    >;
